...
### Applying Configuration with `kubectl  -apply`

1\. Fork and Clone the repo

```bash
git clone https://github.com/bitprj/tinyhats.git
```

2\. apply the configuration YAML files to your Kubernetes cluster by running
